...
namespace AyuboDrive
{
    ...
    {
        public int calculateVehicleRent(string vehicleNo, DateTime rentedDate, DateTime returnDate, bool withDriver) {
            ...
            cmd.CommandText = "select * from VehicleDetails where VehicleNo = '" + vehicleNo + "'";
            ...
            while (sdr.Read()) {
                ...
                dailyDriverCost = Convert.ToInt32(sdr["DailyDriverCost"].ToString());
            }
        ...
        public int[] calculateDayTourHire(string vehicleNo, string pkgType, DateTime startTime, DateTime endTime, int startKMreading, int endKMreading) {
            ...
            SqlCommand cmd1 = new SqlCommand("select VehicleTypeID from VehicleDetails where VehicleNo = '" + vehicleNo + "'", con);
            ...
            foreach (DataRow dr in dt1.Rows) {
                VehicleTypeID = Convert.ToInt32(dr["VehicleTypeID"].ToString());
            }

            SqlCommand cmd2 = new SqlCommand("select ID from DayTourPackageTypes where PackageType = '" + pkgType + "'", con);
            ...
            SqlCommand cmd3 = new SqlCommand("select * from DayTourPackageDetails where VehicleTypeID = '" + VehicleTypeID + "' and PackageTypeID = '" + PackageTypeID + "'", con);
            ...
            foreach (DataRow dr in dt3.Rows) {
                ...
                maxKMLimit = Convert.ToInt32(dr["MaxKMLimit"].ToString());
                extraKMRate = Convert.ToInt32(dr["ExtraKMRate"].ToString());
                maxNoOfHours = Convert.ToInt32(dr["MaxNoOfHours"].ToString());
        ...
        public int[] calculateLongTourHire(string vehicleNo, string pkgType, DateTime startDate, DateTime endDate, int startKMreading, int endKMreading) {
            ...
            SqlCommand cmd2 = new SqlCommand("select ID from LongTourPackageTypes where PackageType = '" + pkgType + "'", con);
            cmd2.ExecuteNonQuery();
            ...
            SqlCommand cmd3 = new SqlCommand("select * from LongTourPackageDetails where VehicleTypeID = '" + VehicleTypeID + "' and PackageTypeID = '" + PackageTypeID + "'", con);
            cmd3.ExecuteNonQuery();
